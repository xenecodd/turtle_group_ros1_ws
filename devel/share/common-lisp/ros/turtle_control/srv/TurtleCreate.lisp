...
(cl:defmethod cl:initialize-instance :after ((m <TurtleCreate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurtleCreate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_control-srv:<TurtleCreate-request> is deprecated: use turtle_control-srv:TurtleCreate-request instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <TurtleCreate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_control-srv:num-val is deprecated.  Use turtle_control-srv:num instead.")
  (num m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurtleCreate-request>)))
  ...
  "turtle_control/TurtleCreateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurtleCreate-request)))
  "Returns string type for a service object of type 'TurtleCreate-request"
  "turtle_control/TurtleCreateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TurtleCreate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurtleCreate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_control-srv:<TurtleCreate-response> is deprecated: use turtle_control-srv:TurtleCreate-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurtleCreate-response>)))
  ...
  "turtle_control/TurtleCreateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurtleCreate-response)))
  "Returns string type for a service object of type 'TurtleCreate-response"
  "turtle_control/TurtleCreateResponse")
