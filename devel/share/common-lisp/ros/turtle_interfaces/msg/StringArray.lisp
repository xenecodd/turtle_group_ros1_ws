...
(cl:in-package turtle_interfaces-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <StringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_interfaces-msg:<StringArray> is deprecated: use turtle_interfaces-msg:StringArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <StringArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_interfaces-msg:data-val is deprecated.  Use turtle_interfaces-msg:data instead.")
  (data m))
